...
export const INITIAL_BINGO_TILES: BingoTile[][] = [
  [
    { id: 'b1-1', taskName: '喝咖啡', completed: false, difficulty: 'easy', xpValue: 10 },
    { id: 'b1-2', taskName: '吃药', completed: false, difficulty: 'easy', xpValue: 10 },
    { id: 'b1-3', taskName: '蛋白饮', completed: false, difficulty: 'medium', xpValue: 20 },
    { id: 'b1-4', taskName: '喝水', completed: false, difficulty: 'easy', xpValue: 10 },
  ...
  [
    ...
    { id: 'b2-2', taskName: '整理床铺', completed: false, difficulty: 'easy', xpValue: 10 },
    { id: 'b2-3', taskName: '日记', completed: false, difficulty: 'medium', xpValue: 20, isGolden: true },
    { id: 'b2-4', taskName: '查收信件', completed: false, difficulty: 'easy', xpValue: 10 },
    { id: 'b2-5', taskName: '拉伸', completed: false, difficulty: 'medium', xpValue: 20 },
  ],
  [
    { id: 'b3-1', taskName: '护肤', completed: false, difficulty: 'easy', xpValue: 10 },
    { id: 'b3-2', taskName: '吃水果', completed: false, difficulty: 'easy', xpValue: 10 },
    { id: 'b3-3', taskName: '自由格', completed: false, isFreeTile: true, xpValue: 5 },
    { id: 'b3-4', taskName: '给妈妈打电话', completed: false, difficulty: 'medium', xpValue: 20 },
    { id: 'b3-5', taskName: '洗碗', completed: false, difficulty: 'medium', xpValue: 20 },
  ],
  [
    { id: 'b4-1', taskName: '洗澡', completed: false, difficulty: 'easy', xpValue: 10 },
    { id: 'b4-2', taskName: '维他命', completed: false, difficulty: 'easy', xpValue: 10 },
    { id: 'b4-3', taskName: '邮件', completed: false, difficulty: 'medium', xpValue: 20 },
    { id: 'b4-4', taskName: '付账单', completed: false, difficulty: 'hard', xpValue: 50 },
    { id: 'b4-5', taskName: '洗衣服', completed: false, difficulty: 'medium', xpValue: 20 },
  ],
  [
    { id: 'b5-1', taskName: '健康零食', completed: false, difficulty: 'easy', xpValue: 10 },
    { id: 'b5-2', taskName: '整理书桌', completed: false, difficulty: 'medium', xpValue: 20 },
    { id: 'b5-3', taskName: '不喝苏打水', completed: false, difficulty: 'easy', xpValue: 10 },
