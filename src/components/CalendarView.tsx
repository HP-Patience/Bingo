    ...
    <div className="space-y-8">
      ...
      <AnimatePresence mode="wait">
        {subTab === 'calendar' ? (
          ...
          <motion.div key="history" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-10">
            {sortedHistoryDates.length > 0 ? (
              ...
              <div className="text-center py-20 space-y-4">
                <div className="inline-block p-6 rounded-full bg-surface-container-low text-on-surface-variant/20"><CalendarIcon className="w-12 h-12" /></div>
