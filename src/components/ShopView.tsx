    ...
    <div className="space-y-10">
      ...
      <section className="space-y-6">
        <div className="flex items-baseline justify-between">
          ...
          {isManageMode && <button onClick={() => setIsAdding(true)} className="bg-primary text-on-primary px-4 py-2 rounded-full font-bold text-[10px] uppercase tracking-widest flex items-center gap-2"><Plus className="w-3 h-3" /> 新增商品</button>}
        </div>
